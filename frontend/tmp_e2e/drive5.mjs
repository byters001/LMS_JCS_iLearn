...
// Find the card whose heading is exactly "toooo"
const heading = page.getByRole('heading', { name: 'toooo', exact: true })
await heading.scrollIntoViewIfNeeded()
const card = heading.locator('xpath=ancestor::*[.//button][1]')
const startBtn = card.getByRole('button', { name: /start test/i })
console.log('start button count:', await startBtn.count())
await startBtn.click()
await page.waitForTimeout(2000)
console.log('URL after start:', page.url())
await shot('13-after-start.png')
