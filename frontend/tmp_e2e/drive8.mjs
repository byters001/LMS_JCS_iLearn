...
await shot('20-dashboard.png')

// Click the "toooo" card link directly (client-side nav, keeps cache warm)
await page.locator('a[href="/student/assessments/f4fde0e5-20df-4b74-875c-afb304bc8581"]').click()
await page.waitForTimeout(1500)
console.log('URL:', page.url())
await shot('21-instructions.png')

const texts = (await page.locator('button, a').allTextContents()).filter(t => t.trim())
console.log('clickable texts:', JSON.stringify(texts))
